/* Lucide-style line icons, inlined so the design stays dependency-free. */

const Svg = ({ size = 20, stroke = 2, children, ...rest }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const LayoutTemplateIcon = (p) => (
  <Svg {...p}>
...
/* Figma draws "Exit Setup" with a single stroked circle-x glyph (ring +
